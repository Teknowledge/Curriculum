...
# Challenge fun.1: Change the first statement "Press enter to roll one die." so
#    that you have to actually press enter first.
# Hint: What function makes the user input something? :)

# Challenge fun.2: If you play the game a few times you will realize the answer
...
# Challenge fun.3: After the first roll, ask the player
...
# BONUS Challenge fun.4: Change the program to roll two dice (with an option
#    for re-rolling) and ask you

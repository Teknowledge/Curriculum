...
# Challenge 1.0 - The add function doesn't work right! Why is that? Fix it
...
# Challenge 1.1 - The subtract function is missing! Add it.

# Challenge 1.2 - Add a function called difference(x, y) that is like subtract
...
# BONUS Challenge - Google search "Python math operators" and see if you can
#    add these three new "crunch functions":

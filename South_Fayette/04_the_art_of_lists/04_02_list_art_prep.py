...
#    spot!
#    (Note: You can use the coordinates for both drawing rectangles and ovals.)

# Challenge 2.4 - Now, add some new rows to drawingsList, like:
#      ('navy', 'rectangle'),
#      ('gold', 'oval'),
...
#    Hint: You will need code like:
#      if (len(drawingTuple) == 2):
#        ...
#      else:
#        ...

# BONUS Challenge - NONE!  (We will continue this example next week, so get
#    excited for more cool random drawing list art!)

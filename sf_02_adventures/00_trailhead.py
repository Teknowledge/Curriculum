...
#    print. What does result equal?
#    (Hint: what is the function returning now?)

# Challenge 0.2 - Add a return to each function, to return the distance
#    traveled in each trail: 5 for red, 2 for blue, 7 for green.
...
#    so you now hike three trails. Then, still print:

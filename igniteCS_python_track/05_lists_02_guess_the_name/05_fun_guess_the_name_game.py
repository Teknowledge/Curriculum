...
# Challenge fun.1 - Make a game, using print() and input() that picks a random
#    name using randint(low, high), then tells you the first letter, the last
#    letter, and the length of the name, then asks you to guess the name and
#    tells you "Right!" or "Wrong :(".

# BONUS Challenge fun.2: Have the game keep playing until you get 5 names correct,

...
#    delete, one-by-one, the comments (only the "#", not the whole line)
#    from lines 6, 7, and 8. Try to predict where each rectangle will draw on
#    the screen.

# Challenge 1.2 - Fill in the dimensions to draw the last lightblue rectangle
#    at the BOTTOM LEFT of the 200x200 screen.

# Challenge 1.3 - Delete the rest of the #s. Run it to see what it does.
